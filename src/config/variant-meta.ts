...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  berlin: {
    title: 'Berlin Monitor - Real-Time Berlin City Dashboard',
    description: 'Real-time Berlin city dashboard with live BVG transit disruptions, local news, weather alerts, and city intelligence — in English and German.',
    keywords: 'Berlin dashboard, BVG disruptions, S-Bahn delays, U-Bahn status, Berlin news, Berlin weather, Berlin transit, RBB, Tagesspiegel, Berlin city monitor, Berlin intelligence',
    url: 'https://berlin-monitor.vercel.app/',
    siteName: 'Berlin Monitor',
    shortName: 'BerlinMonitor',
    subject: 'Berlin City Intelligence — Transit, News & Weather',
    classification: 'City Dashboard, Transit Tracker, Local News Aggregator',
    categories: ['news', 'productivity'],
    features: [
      'BVG transit disruptions',
      'S-Bahn & U-Bahn status',
      'Berlin news aggregation',
      'AI Berlin brief in English & German',
      'DWD weather alerts',
      'Berlin city map',
